...
have a volume of n^3, the cube above will have volume of (n-1)^3 and so on until the top which will
...
to return the integer n such as n^3 + (n-1)^3 + ... + 1^3 = m if such a n exists or -1 if there is
no such n.
Examples:
